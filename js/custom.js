...
$("#newsletter-form").submit(function (e) {
    ...
    //initalizes array for checkbox-values
    var newsletterThemen = new Array();

    //read
    $('input[name="newsletter-themen"]:checked').each(function() {
        newsletterThemen.push(this.value);
    });

    var dataString = 'email=' + email + '&themen=' + newsletterThemen;
    ...
    if (isValidEmail(email) && (newsletterThemen.length > 0)) {
        $.ajax({
            type: "POST",
            url: "sendmail.php",
            data: dataString,
